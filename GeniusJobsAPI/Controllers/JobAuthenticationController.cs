...
namespace GeniusJobsAPI.Controllers
{
    ...
    public class JobAuthenticationController : ApiController
    {
                    ...
                    foreach (var val in provider.FormData.GetValues(key))
                    {
                        ...
                        switch (key)
                        {
                            ...
                            case "KeySkill":
                                ...
                                //case "ResumeFile":
                                //    JResumeData = Convert.FromBase64String(val);
                                //    break;
                        }
                    }
                }
        ...
        //        retValue = objDB.SqlGetData("RMSJSResumeDetailsAdd", ref lst, ExecType.Dynamic, ReturnDBOperation.InUpDel, ref ReturnStatus);
